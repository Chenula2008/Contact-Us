...
function sendEmail() {
    ...
    Email.send({
        SecureToken: "35444c79-5c2f-4cd5-b441-f58d8ad812ef",
        To: 'chenula2008@gmail.com',
        From: "chenula2008@gmail.com",
...
function checkEmail() {
     const emailReagx = /^([a-z\d\.-]+)@([a-z\d-]+)\.([a-z]{2,3})(\.[a-z]{2,3})?$/;

     const errorTxtEmail = document.querySelector(".error-text.email");

     if (!email.value.match(emailReagx)) { 
